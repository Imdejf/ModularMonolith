using JustCommerce.Modules.Identity.Infrastructure.Configuration.Processing.Inbox;
...
namespace JustCommerce.Modules.Identity.Infrastructure.Configuration.Quartz
{
